...
ggplot(coffee,aes(x=Qualityclass,y=category_two_defects,fill=Qualityclass))+
  geom_boxplot()+
...
ggplot(coffee,aes(x=Qualityclass,y=harvested,fill=Qualityclass))+
  geom_boxplot()+
  labs(x="Coffee Quality",y="Harvest Year",
       title="Relationship between Harvest Year and Coffee Quality")
